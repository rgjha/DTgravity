...
long int  number_measure=0,legal_subsimplex[DPLUS],max_point;
long int
...
double len_dist[INCVOL],qdist[INCVOL],len[VOL];
double prob[STEPS],dprob[STEPS];
...
double **L,**LTRANS;
double *sI,*sJ,*sK,*sL;
int *rowI,*rowJ,*rowK,*rowL,*colI,*colJ,*colK,*colL;


int DminusOneNumber,DminusTwoNumber,DminusThreeNumber,DminusFourNumber;
double MASS;
int Dm1num,Dm2num,Dm3num,Dm4num;
...
(void)printf("measurement number %ld\n",number_measure);
